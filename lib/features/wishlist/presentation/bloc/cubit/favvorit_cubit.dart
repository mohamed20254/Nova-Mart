...
import '../favorit_cuibt/favvorit_cubit.dart';
...
class FavvoritCubit extends Cubit<FavvoritState> {
  ...
  Future<void> getFavorits() async {
    ...
    res.fold(
      ...
      (r) => emit(Favvorloaded(favorits: r)),
    );
  }
  ...
  Future<void> addFav({
    ...
    addFavUseCase.call(product: product, contex: context);
    getFavorits();
  }
  ...
  Future<void> removeFav({
    ...
    removeFavUsecase.call(id: id, context: context);
    getFavorits();
  }
